...
# ==================== Configuration ====================
DB_PATH = "/mnt/n1/dbpath/leader"
WORKLOAD_PATH = "../ycsb_workload"
EXP_ROOT = "../new_exp"
BREAKDOWN_SUFFIX = 1024
...
def collect_trace_breakdown(exp_dir, bench_names, use_li, suffix):
    ...
    for bench in bench_names:
        ...
        src_candidates = [
            ...
            os.path.join(exp_dir, f"{bench}_trace_stats.json"),
...
def main():
    ...
    #          key_size=DEFAULT_KEY_SIZE, value_size=DEFAULT_VALUE_SIZE, exp_log_path=f"{EXP_ROOT}/k{DEFAULT_KEY_SIZE}_v{DEFAULT_VALUE_SIZE}/random_0/li/")
